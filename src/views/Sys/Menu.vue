   ...
   <div class="container" style="width:99%;margin-top:-25px;">
     ...
     <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
       <el-form :inline="true" :model="filters" :size="size">
         ...
         <el-form-item>
           <kt-button label="查询" perms="sys:menu:view"
          type="primary" @click="findTreeData(null)"/>
         </el-form-item>
         <el-form-item>
           <kt-button label="新增" perms="sys:menu:add" type="primary"
           @click="handleAdd"/>
         </el-form-item>
       </el-form>
     </div>
     ...
     <el-table :data="tableTreeData" stripe size="mini" style="sidth:100%;"
      ...
      <el-table-column
       ...
       <el-table-column
        ...
        <template slot-scope="scope">
          <kt-button label="修改" perms="sys:menu:edit" @click="handleEdit(scope.row)"></kt-button>
          <kt-button label="删除" perms="sys:menu:delete" type="danger" @click="handleDelete(scope.row)"></kt-button>
        </template>
      </el-table-column>
     </el-table>
     <!--新增修改界面-->
     ...
     :visible.sync="dialogVisible" :close-on-click-modal="false">
       ...
       label-width="80px" :size="size" style="text-align:left;">
         ...
         <el-form-item v-if="dataForm.type!==0" label="授权标识" prop="perms">
           <el-input v-model="dataForm.perms" placeholder="如:sys:user:add,sys:user:edit"></el-input>
         </el-form-item>
         ...
         <el-form-item v-if="dataForm.type !==2" label="菜单图标" prop="icon">
           <el-row>
             ...
             <el-col :span="2" class="icon-list__tips">
               <fa-icon-tooltip></fa-icon-tooltip>
             </el-col>
           </el-row>
         </el-form-item>
       </el-form>
